<?php
/**
 * Srizon One functions and definitions
 *
...
if ( ! function_exists( 'srizon_product_setup' ) ) :
	...
	function srizon_product_setup() {
		 ...
		 * to change 'srizon-one' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'srizon-one', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'srizon-one' ),
		) );
...
function srizon_product_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'srizon-one' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'srizon-one' ),
